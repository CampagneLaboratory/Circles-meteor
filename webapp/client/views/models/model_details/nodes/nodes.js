...
Template.ModelsModelDetailsNodesView.events({
	...
	"click #dataview-insert-button": function(e, t) {
		e.preventDefault();
		Router.go("models.model_details.insert", {modelId: this.params.modelId});
	},
...
Template.ModelsModelDetailsNodesViewTableItems.events({
	...
	"click #edit-button": function(e, t) {
		e.preventDefault();
		Router.go("models.model_details.edit", {modelId: UI._parentData(1).params.modelId, nodeId: this._id});
		return false;
	}
});
